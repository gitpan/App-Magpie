...
eval { $v .= pmver('MetaCPAN::Client','any version') };
...
eval { $v .= pmver('ORDB::CPAN::Mageia','any version') };
eval { $v .= pmver('Parallel::ForkManager','any version') };
eval { $v .= pmver('Parse::CPAN::Meta','1.4401') };
eval { $v .= pmver('Parse::CPAN::Packages::Fast','any version') };
eval { $v .= pmver('Path::Tiny','any version') };
eval { $v .= pmver('RRDTool::OO','any version') };
